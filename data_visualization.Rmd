...
On ajoute nos lettres au boxplot avec la fonction geom_text(), avec comme argument aes() la table que l'on vient de créer. On peut aussi ajouter la statistique de test.
