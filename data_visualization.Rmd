...
Les figures sont des représentations visuelles des résultats. Elles rendent la lectures des résultats principaux plus facile et permettent de mettre en évidence des tendances ou motifs intéressants. Elles doivent contenir:

+ **Titre**: les variables mesurées, les unités de mesure,

+ **Titre des axes**

+ **Barres d'erreurs**: les inclure pour indiquer l'erreur standard autour d'une moyenne
...
Les tableaux présentent habituellement des résultats plus complexes qui seraient trop encombrants à inclure dans une figure ou dans le texte. Les lignes et les colonnes doivent contenir le nom de la variable ainsi que l'unité de mesure.

(ne pas juste mettre un copier-coller du summary de l'analyse)

## Légende d'une figure ou d'un tableau
taille d'échantillon, valeur p, différencier les traitements, abréviations, la méthode de collection, 

## Annexe ou pas?
Les données ou les figures qui ne contribuent pas directement à l'histoire principale de votre rapport peuvent être rassemblées en annexes. Dans cette section, on peut retrouver, par exemple, des cartes du site d'échantillonnage, du matériel utilisé pour récolter les données, 
