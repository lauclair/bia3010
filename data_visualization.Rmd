...
pca.plot <- ggord(pca.dune, xlims=c(-0.75,1), ylims=c(-0.75,0.75),
                  axes=c(1,2),
                  size=3, # taille des points (sites)
                  ...
                  addsize=3, # taille des points (espèces)
...
Maintenant on veut juste garder les espèces qui ont les plus hauts scores (en valeur absolue) sur les axes 1 et 2.
Explorons visuellement le graphique et choisissons les espèces à garder.
...
```{r}
sp.scores.df.skimmed <- sp.scores.df
```
