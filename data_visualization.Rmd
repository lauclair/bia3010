...
+ **Un titre descriptif**: les variables mesurées, les unités de mesure, . Le titre doit fournir assez d'information pour qu'on comprenne le contexte de la figure sans devoir référer au texte.
...
Les tableaux présentent habituellement des résultats plus complexes qui seraient trop encombrants à inclure dans une figure ou dans le texte. Généralement, si les données ne peuvent être présentées en une ou deux phrases, un tableau est nécessaire. Les lignes et les colonnes doivent contenir le nom de la variable ainsi que l'unité de mesure.
