...
## Créer un thème custom pour ggplot. Allez explorer les options (liste des arguments dans le fichier help, lorsque vous rentrez ?theme dans la console de R).
```{r}
super_theme <- theme(
...
Extraire les scores de CA avec la fonction `scores`. Pour spécifier à ggplot quels sont les "points" à mettre en graphique.
```{r}
...
pcoa.plot <- 
  ...
  geom_point(aes(shape = Management, color = Management), size=3) +
  xlab("PCoA1 (35.10%)") + ylab("PCoA3 (9.44%)") +
