...
Les différents termes (paramètres)*(la valeur de x) sont additionnés pour obtenir la variable réponse. 
...
geom_line(data = predictions.masse.sexe2, aes(x=x, y=predicted, color=group), show.legend = TRUE, linewidth=1.1)
plot.masse.sexe
