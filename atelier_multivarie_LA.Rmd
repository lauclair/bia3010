...
Nos objets (sites) peuvent être ordonnés dans un espace multidimensionnel en fonction de leur ressemblance. Les sites situés plus proches l'un de l'autre dans cet espace sont plus similaires dans leur composition en espèces que les sites situés plus loin. Cet espace comporte autant de dimension que de descripteurs (espèces). Il est donc très difficile de visualiser cet espace: comment représenter un espace qui a plus de 3 dimensions!
