...
Mais attention! Les variables dont la corrélation est forte n'expliquent pas nécessairement la composition en espèces de nos sites, mais sont plutôt associées à la variation extraite par les axes de l'ordination.
...
Il peut être difficile de choisir quelle méthode d'ordination pour répondre à vos questions de recherche. De manière générale, pour le genre de données que vous avez récoltées, la CA et la PCA s'avèrent des méthodes très puissantes. Or, rien de mieux que de s'amuser à explorer et comparer les différentes méthodes!
