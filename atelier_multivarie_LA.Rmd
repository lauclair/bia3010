...
La PCA est une méthode bien adaptée pour extraire les scores car ce type d'ordination maximise la variation expliquée par les axes.
...
```{r}
(procrustes(ca.varespec, pca.varespec, symmetric = TRUE))
```
