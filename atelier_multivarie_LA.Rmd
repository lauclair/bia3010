...
Allons inspecter en détails l'objet cca qu'on vient de créer, puis visualisons l'ordination en 2D, en créant un graphique **biplot** avec la fonction `plot` pour visualiser les **sites** et les **espèces** le long des deux premiers axes. (étape 3)
```{r}
summary(ca.varespec)
plot(ca.varespec)
```
