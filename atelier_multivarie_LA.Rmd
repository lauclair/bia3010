...
---
# Analyses multivariées - quelques bases! laurielaurielaurie jocelyn
...
## Différents types d'analyse pour différentes questions
...
Pour chacun de ces types de prédictions, nous verrons une méthode différente. Il existe différentes questions nécessitant différentes méthodes. Par exemple, vous pourriez vouloir tester si deux matrices d'abondances aux mêmes sites sont corrélées. Nous ne verrons pas de méthode pour répondre à cette question ici, mais sachez qu'elles existent.
